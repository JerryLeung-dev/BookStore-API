...
{
    /// <summary>
    /// Endpoint sed to interact with the Authors in the book store's database
    /// </summary>
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAuthors()
        {
            try
            {
                ...
                _logger.LogInfo("Successfull got all Authors");
                return Ok(response);
            }
            catch(Exception e)
            {
        ...
        public async Task<IActionResult> GetAuthor(int id)
        {
            try
            {
                ...
                _logger.LogInfo($"Successuflly got author with id:{id}");
                return Ok(response);
            }
            catch (Exception e)
            {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if(id < 1)
                {
                    _logger.LogWarn($"Delete Author failed with bad data");
                    return BadRequest();
                }
                var isExist = await _authorRepository.IsExist(id);
                if (!isExist)
